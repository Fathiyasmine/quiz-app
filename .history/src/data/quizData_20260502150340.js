    ...
    questions: [
      ...
      },
      {
        ...
        options: [
          ...
          "Une machine qui apprend seule à partir de données",
          "Un réseau social",
      ...
      {
        question:
          "Quelle technologie permet la communication sans fil à courte portée ?",
        options: ["4G", "Bluetooth", "Fibre optique", "ADSL"],
        correctAnswer: 1,
      },
      {
        question: "Que signifie IP dans réseau informatique ?",
        options: [
          "Internet Protocol",
          "Internal Process",
          "Interface Provider",
      ...
      {
        question: "Qu'est-ce qu'un réseau 5G ?",
        options: [
          "La 5ème génération de réseaux mobiles",
          "Un réseau WiFi très rapide",
          "Un câble internet",
          "Un satellite",
        ],
        correctAnswer: 0,
      ...
      {
        question: "Quel modèle d'IA est utilisé dans les voitures autonomes ?",
        options: [
          "Machine Learning",
          "Deep Learning",
      ...
      },
      {
        ...
        options: [
          "Un câble qui transmet des données via la lumière",
          "Un réseau sans fil",
          "Un type de WiFi",
