...
const HeaderQuiz = () => {
  ...
  const { timeRemaining, formatTime } = useQuiz(); // ⏱️ Timer et fonction depuis le Context

  // Trouver le quiz correspondant à l'ID
  const quiz = quizzes.find((q) => q.id === parseInt(id));

  // Si le quiz n'existe pas, afficher un message
  if (!quiz) return <div>Quiz not found</div>;

  return (
    // Header avec fond bleu dégradé et bords arrondis en bas
    <div className="bg-gradient-to-br from-blue-500 to-blue-600 text-white p-6 pb-8 rounded-b-3xl">
      <div className="flex items-center justify-between mb-4">
        ...
        {/* ⏱️ TIMER - Change de couleur si < 60 secondes */}
        <div
