      ...
      <div className="bg-white  -mt-4 rounded-2xl shadow-lg p-6 min-h-[600px] flex flex-col">
        ...
        <div className="flex gap-4 justify-between items-center mt-auto">
          ...
          {currentQuestion < currentQuiz.questions.length - 1 ? (
            <button
              disabled
              className="flex-1 bg- border-2 border-blue-500 text-blue-500 py-3 rounded-xl font-semibold hover:bg-blue-50"
            >
              Submit Quiz
            </button>
          ) : (
            <button
              ...
              className="w-14 h-14 rounded-full bg-gray-200 text-gray-400 flex items-center justify-center hover:bg-gray-300"
            >
              <ArrowForward />
            </button>
          )}
