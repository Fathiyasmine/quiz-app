...
const QuizPage = () => {
  ...
  return (
    <div className="bg-white -mt-11 rounded-t-3xl p-6 pb-20 relative min-h-full shadow-md">
          ...
          <button
            ...
            className={`w-10 h-10 rounded-full shrink-0 font-semibold ${
              index === currentQuestion
                ? "bg-[#2F96E8] text-white dark:bg-blue-600"
      ...
      {/* Question */}
      <h2 className="text-lg font-semibold mb-6 mt-4 dark:text-black">
        {question.question}
      </h2>
      ...
      <div className="flex flex-col flex-1">
        <div className="space-y-4 mb-18">
          {question.options.map((option, index) => (
            <div
              ...
              className={`w-full p-2 rounded-xl text-left flex items-center gap-3 transition cursor-pointer dark:text-black ${
        ...
        {/* Navigation */}
        <div className="flex gap-2 justify-between items-center mt-32">
          {/* Bouton Précédent */}
          <button
            ...
            className={`w-12 h-12 rounded-full flex items-center justify-center ${
              currentQuestion === 0
                ...
                : "bg-[#2F96E8] text-white hover:bg-blue-700 dark:bg-blue-600"
            }`}
          >
