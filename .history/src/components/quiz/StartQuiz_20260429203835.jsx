...
const QuizPage = () => {
  ...
  return (
    <div className="bg-white -mt-10 rounded-t-3xl shadow-lg p-6 flex flex-col min-h-full">
      ...
      <div className="flex flex-col justify-between flex-1 min-h-screen">
        ...
        <div className="flex gap-2 justify-between items-center mt-auto">
          ...
          <button
            ...
            className={`flex-1 border-2 py-3 rounded-xl font-semibold transition  mt-10 ${
              areAllQuestionsAnswered()
