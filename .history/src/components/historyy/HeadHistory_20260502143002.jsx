...
const HeadHistory = ({ results }) => {
  ...
  return (
    <div className="bg-gradient-to-br from-blue-500 to-blue-600 dark:from-blue-800 dark:to-blue-900 text-white p-6 rounded-b-3xl pb-20">
      {" "}
      ...
      <span className="text-3xl font-bold flex justify-center align-top mb-6">
        Quiz History
      </span>
