...
const HeadHistory = () => {
  ...
  return (
    <div className="bg-linear-to-br from-blue-500 to-blue-600 text-white p-6 rounded-b-3xl pb-20">
      ...
      <div className="bg-gray-50 border border-gray-100 rounded-2xl p-2 flex flex-row items-center justify-between w-full">
        <div className="text-md mb-1 font-dm rounded-2xl bg-gray-50 px-3 py-1 text-gray-600 flex-col flex">
          TOTAL QUIZZES
        </div>
        <div>
