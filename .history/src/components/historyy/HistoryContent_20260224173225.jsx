  ...
  return (
    <div className="bg-white -mt-10 rounded-t-3xl shadow-lg p-6 flex flex-col min-h-screen">
      ...
      <div className="flex justify-center flex-col  items-center pt-6 space-y-4">
        <div className="bg-gray-100 border border-gary-100 rounded-2xl p-2 flex flex-col items-center gap-1">
          <span className="text-m font-medium text-gray-400">UI UX DESIGN</span>
          <span className="text-m font-medium text-gray-400">
            Feb 12.2026 | 12 mint
          </span>
        </div>
        <div className="bg-gray-100 border border-gray-100 rounded-2xl p-2 flex flex-col items-center gap-1 fleex-1">
          <span className="text-m font-medium text-gray-400">UI UX DESIGN</span>
          <span className="text-m font-medium text-gray-400">
            Feb 10.2026 | 15 mint
          </span>
        </div>
        <div className="bg-gray-100 border border-gray-100 rounded-2xl p-2 flex flex-col items-center gap-1">
          <span className="text-m font-medium text-gray-400">UI UX DESIGN</span>
          <span className="text-m font-medium text-gray-400">
            Feb 20.2026 | 20 mint
          </span>
