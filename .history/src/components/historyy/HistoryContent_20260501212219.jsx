...
const HistoryContent = ({ results }) => {
  ...
  return (
    <div className="dark:bg-gradient-to-br from-blue-800 to-blue-900 -mt-10 rounded-t-3xl shadow-lg p-6 flex flex-col min-h-screen">
      {/* tabs */}
        ...
        {tabs.map((tab) => (
          <button
            ...
            className={`px-4 py-2 rounded-full border-none cursor-pointer font-semibold text-sm transition-all
              ${
                active === tab
                  ? "bg-gradient-to-r from-blue-400 to-blue-300 dark:bg-gradient-to-r from-blue-800 to-blue-900 text-white shadow-md shadow-blue-200"
