...
export default Log;
/*
+ import api          →  utilise notre fichier api.js
+ async/await         →  appel réel au backend
+ localStorage        →  sauvegarde token + name
+ error state         →  affiche les erreurs (mauvais mdp...)
+ loading state       →  bouton "Connexion..." pendant l'appel
- navigate dans button →  supprimé, navigate est dans le try maintenant
*/
