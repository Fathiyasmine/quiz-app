    ...
    <div className="bg-white -mt-10 rounded-t-3xl shadow-lg p-6 flex flex-col min-h-screen">
      ...
      <Box component="form" onSubmit={handleSubmit}>
        ...
        <button
          ...
          className="w-full bg-linear-to-r from-[#3550DC] to-[#27E9F7] text-white py-4 rounded-xl font-semibold hover:shadow-lg transition-shadow"
        >
          Sign In
        </button>
      </Box>
      ...
      <div>
        <div>
          <button
            onClick={() => navigate("/home")}
            className="w-1/2 bg-linear-to-r from-[#3550DC] to-[#27E9F7] text-white py-4 rounded-xl font-semibold hover:shadow-lg transition-shadow"
          >
            Google
          </button>
        </div>
