...
const ResultsContent = () => {
  return (
    <div className="p-6 flex flex-row flex-wrap items-center gap-6 justify-center bg-white -mt-10 rounded-t-3xl shadow-lg p-6 flex flex-col min-h-screen  ">
      ...
      <div className="bg-red-50 border border-red-100 rounded-2xl p-4 flex items-center gap-1 w-1/3">
      ...
      <div className="bg-purple-50 border border-purple-100 rounded-2xl p-4 flex items-center gap-1 w-1/3">
