  ...
  return (
    <div className="p-6 bg-white rounded-t-3xl shadow-lg min-h-screen relative">
      ...
      {showCongrats && (
        ...
        >
          <img
            src="/assets/congrats.gif"   {/* ← mets ton gif ici dans /public/assets/ */}
            alt="Félicitations"
      ...
      <div className="grid grid-cols-2 gap-4">
        ...
        >
          ...
          <div className="flex flex-col">
            <span className="text-2xl font-extrabold text-black">{incorrect}</span>
        ...
        <div className="bg-purple-50 border border-purple-100 rounded-2xl p-4 flex items-center gap-2">
          ...
          <div className="flex flex-col">
            <span className="text-2xl font-extrabold text-black">{formatTime(timeTaken)}</span>
