      ...
      <div className="md:grid md:grid-cols-2 md:gap-10">
        ...
        <div>
          ...
          <div className="grid grid-cols-1 gap-3">
            ...
            <div
              className="bg-green-50 bg-green-900/30 border border-green-100 dark:border-green-800 rounded-2xl p-4 flex justify-center cursor-pointer hover:bg-green-100 dark:hover:bg-green-900/50 transition"
