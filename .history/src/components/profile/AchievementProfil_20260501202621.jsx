      ...
      <div className="md:grid md:grid-cols-2 md:gap-10">
        ...
        <div>
          ...
          <div className="grid grid-cols-1 gap-3">
            <div
              className="bg-blue-50 bg-blue-900/30 border border-blue-100 dark:border-blue-800 rounded-2xl p-4 flex justify-center cursor-pointer hover:bg-blue-100 dark:hover:bg-blue-900/50 transition"
              onClick={() => navigate("/histo")}
            >
              <span className="text-xs text-gray-500 text-gray-300 font-medium uppercase">
                {t("history")}
              </span>
            </div>
            <div
              className="bg-green-50 bg-green-900/30 border border-green-100 border-green-800 rounded-2xl p-4 flex justify-center cursor-pointer hover:bg-green-100 dark:hover:bg-green-900/50 transition"
            ...
            <div
              className="bg-red-50 bg-red-900/30 border border-red-100 border-red-800 rounded-2xl p-4 flex justify-center cursor-pointer hover:bg-red-100 dark:hover:bg-red-900/50 transition"
