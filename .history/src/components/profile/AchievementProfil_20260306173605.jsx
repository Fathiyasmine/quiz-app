  ...
  return (
    <div className="bg-white -mt-10 rounded-t-3xl shadow-lg p-6 flex flex-col min-h-screen">
      ...
      <div className="grid grid-cols-4 gap-2">
        ...
        <div className="flex flex-col items-center gap-2">
          <div className="w-16 h-16 rounded-full flex items-center justify-center bg-linear-to-br from-orange-500 to-red-400 shadow-md">
      ...
      <div className="grid grid-cols-1 gap-3 mt-8">
        <div
          className="bg-blue-50 border border-blue-100 rounded-2xl p-4 flex flex-col items-center gap-1"
        ...
        <div
          className="bg-orange-50 border border-orange-100 rounded-2xl p-4 flex flex-col items-center gap-1"
        ...
        <div
          className="bg-green-50 border border-orange-100 rounded-2xl p-4 flex flex-col items-center gap-1"
