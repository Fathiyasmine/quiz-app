...
const QuizCard = ({ quiz }) => {
  ...
  return (
    <div
      ...
      className="bg-white rounded-lg border-2 border-transparent hover:border-blue-400 p-4 mb-4 mr-2 ml-2 cursor-pointer hover:shadow-lg transition-all"
    >
      <div className="flex items-start gap-4">
        ...
        <div className="flex-1 flex justify-between items-center">
          ...
          <div className="flex flex-col gap-1">
            {/* Titre */}
            <h3 className="text-blue-500 font-semibold text-lg mb-1 font-ubuntu">
              {quiz.title}
            </h3>
            {/* Nombre de questions */}
          ...
          <div className="flex items-center gap-1 text-sm ">
            ...
            <span className="font-semibold bg-gradient-to-r from-[#3550DC] to-[#27E9F7] text-transparent">
              {quiz.rating}
            </span>
          </div>
        </div>
