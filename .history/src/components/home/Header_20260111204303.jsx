...
const HeaderHomePage = () => (
  <div className="bg-gradient-to-br from-blue-600 to-blue-400 text-white p-6 ">
    ...
    <div className="bg-white rounded-full flex items-center px-4 py-3 mb-4 rounded-b-3xl">
      {/*icon de recherche*/}
