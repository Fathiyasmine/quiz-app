...
const QuizCard = ({ quiz }) => {
  ...
  return (
    <div
      ...
      className="bg-white rounded-lg border-2 border-transparent shadow-lg hover:border-blue-400 p-4 mb-4 mr-2 ml-2 cursor-pointer hover:shadow-lg transition-all"
    >
