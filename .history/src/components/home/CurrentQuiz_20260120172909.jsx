      ...
      <div className="bg-white rounded-lg p-6 mb-2 shadow-md border-2 border-transparent hover:shadow-lg hover:border-blue-400 transition ">
        <div className="flex gap-4">
          ...
          <div className="flex flex-col justify-between flex-1">
            ...
            {/* Bouton Continue */}
            <div className="flex justify-center align-center w-full shrink-0">
              <button
                onClick={handleContinue}
                className="px-4 py-2.5 bg-[#333333] text-white rounded-xl font-semibold hover:bg-[#444444] transition"
              >
                Continue Quiz
              </button>
            </div>
