...
const ContinueQuiz = () => {
  ...
  return (
    <div className="p-4">
      <h3 className="font-semibold text-lg mb-3 ml-2">Continue Quiz</h3>
      <div className="bg-white rounded-lg p-4 mb-4  shadow-md border-2 border-transparent hover:shadow-lg hover:border-blue-400 transition">
        <div className="flex gap-4">
          ...
          <div className="flex flex-col justify-between flex-1">
            ...
            <div className="flex justify-center align-items-center">
              <button className="w-52 h-10 flex align-items-center px-6 bg-[#333333] text-white py-3 rounded-xl font-semibold hover:bg-[#444444] transition">
                Continue Quiz
              </button>
            </div>
          </div>
