...
const Header = () => {
  ...
  return (
    /* Header */
    <div className="bg-gradient-to-br from-blue-500 to-blue-600 text-white p-6 rounded-b-3xl pb-30 relative">
      ...
      <div className="flex items-center gap-1 absolute top-88px right-4">
