  ...
  <div className="min-h-screen bg-gray-100">
    ...
    <div className="bg-white mx-6 -mt-24 rounded-2xl shadow-lg p-6">
      ...
      <div className="space-y-4 mb-6">
        ...
        <p className="text-sm text-gray-500">10 point for a correct answer</p>
      </div>
    </div>
    <div className="flex items-center gap-4">
      <div className="w-12 h-12 bg-gray-800 rounded-full flex items-center justify-center">
    ...
    <div className="flex items-center gap-4">
      ...
      <div>
        ...
        <p className="text-sm text-gray-500">Answer all questions correctly</p>
      </div>
    </div>
    <div>
      <p>Please read the text</p>
    </div>
  </div>
);
