    ...
    <div className="min-h-screen bg-gray-100 dark:bg-gray-900">
      ...
      <div className="p-4 md:p-8">
        ...
        >
          ...
          <div
            className={`bg-white dark:bg-gray-800 rounded-3xl shadow-sm p-4 md:p-6 ${hasSavedProgress ? "md:col-span-2" : ""}`}
          >
            <Categories
          ...
          {hasSavedProgress && (
            <div className="bg-white dark:bg-gray-800 rounded-3xl shadow-sm p-4 md:p-6 h-fit">
              <CurrentQuiz />
            </div>
          )}
        </div>
