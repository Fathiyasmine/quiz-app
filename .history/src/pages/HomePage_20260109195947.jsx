    ...
    <div className="min-h-screen bg-gray-100">
      ...
      <div className="px-6 py-4">
        ...
        <div className="mt-6">
          ...
          <button className="flex-1 bg-gray border-2 border-blue-500 text-white py-3 rounded-xl font-semibold">
            Continue Quiz
          </button>{" "}
        </div>

        {/* Start Quiz Button */}
        <button className="w-full bg-white text-blue-500 py-4 rounded-xl mt-6 font-semibold">
          Start Quiz
        </button>
      </div>
    </div>
