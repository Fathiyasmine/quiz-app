...
const HomePage = () => {
  ...
  return (
    <div className="h-full bg-gray-100">
      ...
      {/* Container qui remonte */}
      <div className=" -mt-28 ">
        {/* Card blanche avec padding généreux */}
        <div className="bg-gray-50 rounded-3xl shadow-xl  ">
          <div className="h-1 bg-blue-600 w-16 rounded-md flex justify-center align-middle"></div>
