...
import { ArrowBack, ArrowForward, ArrowBack as ArrowLeft } from '@mui/icons-material';
...
const QuizPage = () => {
  ...
  const handleSubmit = () => {
    ...
    alert(`Quiz completed! Your score: ${score}/${currentQuiz.questions.length * 10}`);
    navigate('/');
  };
        ...
        <div className="flex gap-4 justify-between items-center mt-auto">
          ...
          {currentQuestion === currentQuiz.questions.length - 1 ? (
            ...
            <button
              ...
              className="w-14 h-14 rounded-full bg-gray-200 text-gray-400 flex items-center justify-center hover:bg-gray-300 transition"
            >
              <ArrowForward />
            </button>
          )}
