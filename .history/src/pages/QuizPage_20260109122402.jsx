  ...
  return (
    <div className="min-h-screen bg-gray-100">
      ...
      <div className="bg-white mx-4 -mt-4 rounded-2xl shadow-lg p-6 min-h-[600px]">
        ...
        {/* Question */}
        <h2 className="text-lg font-semibold mb-6">{question.questions}</h2>
        ...
        <div className="space-y-3 mb-8">
          {question.options.map((option, index) => (
            ...
            >
              {/*pour le cercle rond de la reponse choisie */}
              <div
        ...
        {/* Navigation : button pour la question qui precede la currentQuestion if currentQuestion!=0*/}
        <div className="flex gap-4 justify-between items-center">
          ...
          >
            {/*utilisation de licone de MUI pour revenir en arriere */}
            <ArrowLeft />
          </button>
          {/*si on est a la derniere qst on rend le button submit active, sinon on active le button de arrowForward pour la qst suivante */}
