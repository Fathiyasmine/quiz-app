...
// Composant interne qui a accès au contexte Settings
function AppContent() {
  const { darkMode } = useSettings();
  console.log("AppContent darkMode =", darkMode);

  const theme = getTheme(darkMode);

  return (
    <ThemeProvider theme={theme}>
      <CssBaseline /> {/* ← reset CSS pour que le background fonctionne */}
      <QuizProvider>
        <BrowserRouter>
          <Layout>
            <Routes>
