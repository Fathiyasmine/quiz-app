...
Résumé simple
FonctionRôleregistercréer un compte + chiffrer password + retourner tokenloginvérifier email/password + retourner tokengenerateTokencréer un badge JWT avec l'id de l'userbcrypt.hashtransformer "123456" en charabia illisiblebcrypt.comparevérifier si le password tapé correspond au hashjwt.signcréer le tokenjwt.verifyvérifier que le token est valide (étape 7)
*/
