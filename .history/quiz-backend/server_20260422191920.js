...
Étape 9 — Tester avec Postman
Méthode          URLBodyPOST/api/auth/register{ name, email, password }POST/api/auth/login{ email, password }GET/api/quizzesHeader: Authorization: Bearer TOKENPOST/api/results{ quiz, score, total, timeTaken }GET/api/results/meHeader: Authorization: Bearer TOKEN
*/
